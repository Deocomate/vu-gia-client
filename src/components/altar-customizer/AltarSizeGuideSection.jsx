        ...
        <table className="w-full border-collapse table-fixed min-w-[900px]">
          <thead>
            <tr>
              ...
              <th className="h-16 w-[130px] lg:w-[216px] px-4 text-center text-[#2e2f2a] text-[12px] lg:text-[18px] leading-[25px] font-bold uppercase bg-[#f2f3f5]">
                Lọ hoa
              </th>
              <th className="h-16 w-[100px] lg:w-[134px] px-4 text-center text-[#2e2f2a] text-[12px] lg:text-[18px] leading-[25px] font-bold uppercase bg-[#f2f3f5]">
                Chóe
              </th>
              <th className="h-16 w-[100px] lg:w-[154px] px-4 text-center text-[#2e2f2a] text-[12px] lg:text-[18px] leading-[25px] font-bold uppercase bg-[#f2f3f5]">
                Kỷ nước
              </th>
              <th className="h-16 w-[100px] lg:w-[138px] px-4 text-center text-[#2e2f2a] text-[12px] lg:text-[18px] leading-[25px] font-bold uppercase bg-[#f2f3f5]">
                Phụ kiện
              </th>
            </tr>
          </thead>
          <tbody>
            {SIZE_GUIDE_ROWS.map((row) => (
              <tr key={row.stt} className="even:[&>td]:bg-[#f2f3f5]">
                <td className="h-[40px] lg:h-[65px] px-4 text-center text-[#101010] text-[12px] lg:text-[18px] leading-[25px] font-normal">
                  {row.stt}
                </td>
                <td className="h-[40px] lg:h-[65px] px-4 text-center text-[#101010] text-[12px] lg:text-[18px] leading-[25px] font-semibold">
                  {row.altar}
                </td>
                <td className="h-[40px] lg:h-[65px] px-4 text-center text-[#101010] text-[12px] lg:text-[18px] leading-[25px] font-normal">
                  {row.batHuong}
