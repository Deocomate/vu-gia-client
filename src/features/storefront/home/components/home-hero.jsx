...
// Danh mục sidebar trang chủ là nội dung tĩnh cố định theo thiết kế gốc, không
// phụ thuộc `product_categories` (đó là dữ liệu filter thật ở trang danh mục).
const categories = [
  {
    name: "Bộ đồ thờ",
...
export default function HomeHero({ banners = [] }) {
  ...
  // sub-banner slots — only the background image is dynamic, the promo copy
  // stays static like the reference design.
