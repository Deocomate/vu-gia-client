...
export default function FactoryIntro() {
  return (
    <section className="w-full flex flex-col pt-[40px] lg:pt-[119px] pb-0 font-montserrat">
      {/* Title */}
      <h1 className="font-arima text-[#101010] text-[36px] lg:text-[64px] font-[500] leading-[40px] lg:leading-[60px] mb-[40px] lg:mb-[72px] break-words">
        Nghệ thuật chế tác
      </h1>
      ...
      <div className="w-full max-w-[1334px] flex flex-col">
        {/* Subtitle */}
        <h2 className="text-[#101010] text-[16px] lg:text-[20px] font-[600] uppercase leading-[24px] lg:leading-[35px] mb-[10px] break-words">
          Quy mô ấn tượng: 5000m² - 3 tầng vận hành chuyên biệt
        </h2>

        {/* Paragraph Description */}
        <p className="text-[#101010] text-[16px] lg:text-[16px] font-[300] leading-[26px] lg:leading-[28px] max-w-[1438px] break-words">
