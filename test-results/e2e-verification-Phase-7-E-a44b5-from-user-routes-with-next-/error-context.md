...
- Name: e2e-verification.spec.js >> Phase 7 E2E Verification >> Route Guards >> should redirect logged-out user from (user) routes with ?next=
- Location: e2e-verification.spec.js:507:5
...
Received string:    "http://localhost:3000/tai-khoan"
```
